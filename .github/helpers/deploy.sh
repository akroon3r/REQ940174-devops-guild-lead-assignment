...
for i in "${objects[@]}"
do
    oc process -f /home/runner/work/REQ940174-devops-guild-lead-assignment/EQ940174-devops-guild-lead-assignment/openshift/templates/$DIR/"$i" --namespace=$NAMESPACE \
